			...
			<div
				...
				<div className="overflow-y-auto p-3 flex-1 min-h-0 overscroll-contain">
					<div className="flex justify-between items-center mb-3">
						<HeroTooltip
							content="自动批准允许 Cline 无需请求许可即可执行以下操作。请谨慎使用，并仅在您了解风险的情况下启用。."
							placement="top">
					...
					<div className="mb-2.5">
						<span className="text-[color:var(--vscode-foreground)] font-medium">快捷设置:</span>
					</div>
					...
					<HeroTooltip content="Cline 将在请求批准继续执行任务之前自动发出这么多 API 请求。" placement="top">
