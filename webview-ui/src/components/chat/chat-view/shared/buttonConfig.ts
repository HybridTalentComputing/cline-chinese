...
export const BUTTON_CONFIGS: Record<string, ButtonConfig> = {
	...
	api_req_failed: {
		...
		enableButtons: true,
		primaryTextKey: "buttons.retry",
		secondaryTextKey: "buttons.startNewTask",
		primaryAction: "retry",
	...
	mistake_limit_reached: {
		...
		enableButtons: true,
		primaryTextKey: "buttons.proceedAnyways",
		secondaryTextKey: "buttons.startNewTask",
	...
	tool_approve: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.approve",
		secondaryTextKey: "buttons.reject",
	...
	command: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.runCommand",
		secondaryTextKey: "buttons.reject",
		primaryAction: "approve",
		secondaryAction: "reject",
	},
	command_output: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.proceedWhileRunning",
	...
	completion_result: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.startNewTask",
		secondaryTextKey: undefined,
	...
	resume_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.resumeTask",
		secondaryTextKey: undefined,
		primaryAction: "proceed",
		secondaryAction: undefined,
	},
	...
	new_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.startNewTaskWithContext",
		secondaryTextKey: undefined,
		primaryAction: "new_task",
		secondaryAction: undefined,
	},
	...
	condense: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.condenseConversation",
		secondaryTextKey: undefined,
	...
	report_bug: {
		sendingDisabled: false,
		enableButtons: true,
		primaryTextKey: "buttons.reportGithubIssue",
		secondaryTextKey: undefined,
		primaryAction: "utility",
		secondaryAction: undefined,
	},
	...
	partial: {
		...
		enableButtons: true,
		primaryTextKey: undefined,
		secondaryTextKey: "buttons.cancel",
		primaryAction: undefined,
