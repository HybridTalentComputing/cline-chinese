...
export const ClineAccountView = () => {
	...
	async function getUserCredits() {
		setIsLoading(true)
		try {
			const res = await AccountServiceClient.getUserCredits(EmptyRequest.create())
	...
	async function getOrganizationCredits() {
		...
		try {
			const res = await AccountServiceClient.getOrganizationCredits(
	...
	async function getUserOrganizations() {
		setIsLoading(true)
		try {
			const res = await AccountServiceClient.getUserOrganizations(EmptyRequest.create())
			setUserOrganizations(res.organizations || [])
			setActiveOrganization(res.organizations.find((org: UserOrganization) => org.active) || null)
		} catch (error) {
