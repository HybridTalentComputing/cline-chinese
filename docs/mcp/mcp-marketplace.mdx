...
-   此文件位于：`/Users/<username>/Library/Application Support/Code/User/globalStorage/saoudrizwan.cline-chinese/settings/cline_mcp_settings.json`
-   环境变量（如 API 密钥）被安全存储
-   注册服务器路径
...
1. 打开 MCP 设置文件：`/Users/<username>/Library/Application Support/Code/User/globalStorage/saoudrizwan.cline-chinese/settings/cline_mcp_settings.json`
