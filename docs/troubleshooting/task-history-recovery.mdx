...
<Tabs>
	<Tab title="VS Code">
		```bash
		# macOS
		~/Library/Application Support/Code/User/globalStorage/saoudrizwan.cline-chinese/
		# Windows
		%APPDATA%\Code\User\globalStorage\saoudrizwan.cline-chinese\
		# Linux
		~/.config/Code/User/globalStorage/saoudrizwan.cline-chinese/
		```
	</Tab>
	<Tab title="JetBrains">
		```bash
		# macOS
		~/Library/Application Support/JetBrains/<IDE>/globalStorage/saoudrizwan.cline-chinese/
		# Windows
		%APPDATA%\JetBrains\<IDE>\globalStorage\saoudrizwan.cline-chinese\
		# Linux
		~/.config/JetBrains/<IDE>/globalStorage/saoudrizwan.cline-chinese/
		```
	</Tab>
</Tabs>
...
<Tabs>
	<Tab title="VS Code">
		```bash
		# macOS/Linux
		cd ~/.config/Code/User/globalStorage/saoudrizwan.cline-chinese/state/
	...
	<Tab title="JetBrains">
		```bash
		# macOS
		cd ~/Library/Application\ Support/JetBrains/<IDE>/globalStorage/saoudrizwan.cline-chinese/state/
		ls taskHistory.backup.*.json
...
<Steps>
	<Step title="Locate and copy your Cline data">
		On your **old machine**, find the `saoudrizwan.cline-chinese` folder using the [storage paths above](#storage-paths) and copy the entire folder.
	</Step>
	...
	<Step title="Transfer your data">
		Paste the `saoudrizwan.cline-chinese` folder to the same storage path on your new machine.
	</Step>
