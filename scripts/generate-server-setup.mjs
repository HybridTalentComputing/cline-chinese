...
function generateHandlersAndExports() {
	...
	for (const [name, def] of Object.entries(proto.cline_shengsuan)) {
		...
		handlerSetup.push(`    server.addService(cline_shengsuan.${name}Service, {`)
		for (const [rpcName, rpc] of Object.entries(def.service)) {
			imports.push(`import { ${rpcName} } from "@core/controller/${dir}/${rpcName}"`)
			const requestType = "cline_shengsuan." + rpc.requestType.type.name
			...
			if (rpc.responseStream) {
				...
				const responseType = "cline_shengsuan." + rpc.responseType.type.name
...
import * as grpc from "@grpc/grpc-js"
import { cline_shengsuan } from "@generated/grpc-js"
