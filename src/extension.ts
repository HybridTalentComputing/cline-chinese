...
export async function activate(context: vscode.ExtensionContext) {
	...
	const openClineInNewTab = async () => {
		Logger.log("Opening openClineInNewTab in new tab")
		...
		const panel = vscode.window.createWebviewPanel(VscodeWebviewProvider.TAB_PANEL_ID, "ClineShengsuan", targetCol, {
			enableScripts: true,
...
function setupHostProvider(context: ExtensionContext) {
	...
	const getCallbackUri = async () => `${vscode.env.uriScheme || "vscode"}://shengsuan-cloud.cline-shengsuan`
