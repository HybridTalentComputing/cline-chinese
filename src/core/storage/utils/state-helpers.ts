...
export async function readGlobalStateFromDisk(context: ExtensionContext): Promise<GlobalState> {
	try {
		...
		const planModeVercelAiGatewayModelInfo = context.globalState.get("planModeVercelAiGatewayModelInfo") as
			| ModelInfo
			| undefined
		const planModeShengSuanYunModelId = context.globalState.get("planModeShengSuanYunModelId") as string | undefined
		const planModeShengSuanYunModelInfo = context.globalState.get("planModeShengSuanYunModelInfo") as
		...
		const actModeShengSuanYunModelId = context.globalState.get("actModeShengSuanYunModelId") as string | undefined
		const actModeShengSuanYunModelInfo = context.globalState.get("actModeShengSuanYunModelInfo") as
			| ShengSuanYunModelInfo
			| undefined
