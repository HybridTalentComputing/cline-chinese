...
export class CacheService {
	...
	private constructApiConfigurationFromCache(): ApiConfiguration {
		return {
			...
			shengSuanYunApiKey: this.secretsCache.get("shengSuanYunApiKey"),
			...
			shengSuanYunToken: this.globalStateCache.get("shengSuanYunToken"),
			...
			planModeShengSuanYunModelId: this.globalStateCache.get("planModeShengSuanYunModelId"),
			planModeShengSuanYunModelInfo: this.globalStateCache.get("planModeShengSuanYunModelInfo"),
			...
			actModeShengSuanYunModelId: this.globalStateCache.get("actModeShengSuanYunModelId"),
			actModeShengSuanYunModelInfo: this.globalStateCache.get("actModeShengSuanYunModelInfo"),
		} as ApiConfiguration
	}
}
